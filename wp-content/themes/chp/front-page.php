...
<main>
    ...
    <section id="chp_intro">
        <div class="chp_bg_wrapper">
            <div class="container">
                ...
                <p class="portrait-only">
                    <strong>Notre département d’oculoplastie</strong> vous offre la prise en charge des <strong>pathologies des paupières</strong>
                    (malpositions, tumeurs, malformations, etc.), de <strong>l’orbite</strong> (tumeurs, cavités, traumatismes, etc.),
                    des <strong>voies lacrymales</strong> (larmoiement de l’adulte ou de l’enfant) et de <strong>l’esthétique du regard</strong>.
                    <br /><br />
                    Nos ophtalmologues de formation, les docteurs <strong class="color-default bold">Dr. Eric Baggio</strong> et <strong class="color-default bold">Dr. Jérémie Barbier</strong>
                    vous présentent à travers ce site internet les différentes pathologies spécifiques à l’oeil
                    et à ses annexes qui font leur spécificité dans ce domaine.
                </p>
    ...
    <section id="chp_intro_pathologies">
        <div class="chp_bg_wrapper flex col main-center cross-end">
            <div class="container">
                ...
                <p class="chp_intro_paragraph landscape-only">Tout savoir sur les pathologies que nous traitons <br/>et les traitements que nous proposons</p>

                <p class="chp_intro_paragraph portrait-only">Tout savoir sur les pathologies que nous traitons et les traitements que nous proposons</p>
    ...
    <section id="chp_intro_medecins">
        <div class="chp_bg_wrapper">
            <div class="container">
                <h3 class="medecine_section">Nos Médecins</h3>

...
<main>
    ...
    <section id="chp_baggio" class="chp_medecine_content">
        <div class="container">
            ...
            <a href="https://www.doctolib.fr/ophtalmologue/lyon/eric-baggio" target="_blank" class="chp_button chp_button_dark">Prendre rendez-vous <i class="fas fa-chevron-down"></i></a>
        </div>
    </section>

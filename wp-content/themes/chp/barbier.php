...
<main>
    ...
    <section class="chp_header chp_h_medecins">
        <div class="chp_container chp_cliniques flex column main-center cross-center">
            <div class="container">
                <div class="chp_cliniques_image chp_medecins_image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/barbier.jpg" class="nav_img" alt="clinic-photo-thumbnail">
                </div>

                <h1>Dr. Jérémie Barbier</h1>
                ...
                <a href="https://www.doctolib.fr/ophtalmologue/lyon/jeremie-barbier" target="_blank" class="chp_button chp_button_dark chp_button_rdv">Prendre rendez-vous <i class="fas fa-chevron-down"></i></a>
            </div>
        </div>
    </section>
